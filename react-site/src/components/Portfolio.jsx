...
function Portfolio() {
  ...
  return (
    <section id="portfolio" className="pt-20 pb-0 bg-black text-white" style={{ boxShadow: '0 -20px 40px rgba(255, 255, 255, 0.5), 0 12px 24px rgba(0, 0, 0, 0.6)', position: 'relative', zIndex: 10 }}>
      {/* Section Title */}
