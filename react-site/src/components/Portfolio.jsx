...
export default function Portfolio() {
  ...
  if (loading) {
    return (
      <section id="portfolio" className="py-20 text-gray-800" style={{ backgroundColor: '#f9fafb', background: '#f9fafb', width: '100%', position: 'relative', zIndex: 1, opacity: 1 }}>
  ...
  return (
    <section id="portfolio" className="py-20 text-gray-800" style={{ backgroundColor: '#f9fafb', background: '#f9fafb', width: '100%', position: 'relative', zIndex: 1 }}>
      <div className="max-w-7xl mx-auto px-6">
        {!selectedCategory ? (
          <>
