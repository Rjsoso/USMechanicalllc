...
const ServicesSection = () => {
  ...
  if (!servicesData) {
    return (
      <section id="services" className="pt-12 pb-2 bg-black text-white text-center">
  ...
  if (!servicesData?.services || servicesData.services.length === 0) {
    return (
      <section id="services" className="pt-12 pb-2 bg-black text-white">
  ...
  return (
    <section 
      id="services" 
      className="pt-12 pb-2 bg-black text-white"
    >
      <div className="max-w-7xl mx-auto px-6">
        <motion.h2 
          className="section-title text-5xl md:text-6xl text-center mb-12 text-white"
