...
const ServicesSection = () => {
  ...
  if (!servicesData) return <div className="py-20 text-center" style={{ backgroundColor: '#f9fafb' }}>Loading services...</div>;

  if (!servicesData?.services || servicesData.services.length === 0) {
    return (
      <section id="services" className="pt-20 pb-40 bg-gray-50" style={{ backgroundColor: '#f9fafb', background: '#f9fafb' }}>
      <motion.div 
