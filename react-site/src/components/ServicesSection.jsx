...
function ScrollRevealItem({ scrollYProgress, index, baseStart = 0.12, step = 0.06, children }) {
    ...
    <div ref={scrollRef} id="services" style={{ height: '200vh', position: 'relative' }}>
      ...
      >
        <div className="mx-auto max-w-7xl px-6 w-full">
          {/* Section heading */}
          <motion.div style={{ y: headingY, opacity: headingOpacity }} className="mb-10">
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-[5fr_6fr] lg:gap-0">
            ...
            <motion.div
              style={{ y: previewY, opacity: previewOpacity, minHeight: 440 }}
